...
$routes->group('', ['filter' => 'guest'], function (RouteCollection $routes) {
    ...
    $routes->post('login/comment/(:segment)', [AuthController::class, 'loginComment'], ['as' => 'login.comment.post', 'trottle:5,1,ip']);
    $routes->post('login', [AuthController::class, 'login'], ['as' => 'login.post', 'trottle:5,1,ip']);
