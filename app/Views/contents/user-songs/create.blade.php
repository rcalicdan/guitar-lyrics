<div class="card-body">
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route_to('songs.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                ...
                <div x-data="artistSelector()" class="position-relative">
                ...
                <button type="submit" class="btn btn-primary">Publish Song</button>
