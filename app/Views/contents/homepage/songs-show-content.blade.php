...
<section class="py-5">
    <div class="container">
        <!-- Song Meta Card -->
        <div class="song-meta-card mb-4" x-show="true" x-transition:enter="transition ease-out duration-500"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="controls-group">
                        ...
                        <div class="control-item">
                            ...
                            <div class="btn-group" role="group">
                                <button type="button" class="btn btn-outline-secondary btn-sm"
                                    @click="changeFontSize('small')" :class="{ 'active': fontSize === 'small' }">
                                    <i class="fas fa-font" style="font-size: 0.8em;"></i>
                                </button>
                                <button type="button" class="btn btn-outline-secondary btn-sm"
                                    @click="changeFontSize('medium')" :class="{ 'active': fontSize === 'medium' }">
                                    <i class="fas fa-font" style="font-size: 1em;"></i>
                                </button>
                                <button type="button" class="btn btn-outline-secondary btn-sm"
                                    @click="changeFontSize('large')" :class="{ 'active': fontSize === 'large' }">
                        ...
                        <!-- Auto-scroll Control -->
                        <div class="control-item">
                            <button @click="toggleAutoScroll()" class="btn btn-outline-primary btn-sm"
        ...
        <!-- Main Content -->
        <div class="content-section" x-show="true" x-transition:enter="transition ease-out duration-500 delay-200"
            x-transition:enter-start="opacity-0 transform translate-y-4"
            x-transition:enter-end="opacity-100 transform translate-y-0">
            <div class="chord-content" :class="'font-size-' + fontSize" x-ref="chordContent">
                {!! $song->content !!}
            </div>
        </div>

        <!-- Related Songs (if any) -->
        <div class="related-songs mt-5" x-show="relatedSongs.length > 0"
            x-transition:enter="transition ease-out duration-500 delay-300"
            x-transition:enter-start="opacity-0 transform translate-y-4"
            x-transition:enter-end="opacity-100 transform translate-y-0">
            <h4 class="mb-4">
                <i class="fas fa-music me-2 text-primary"></i>Related Songs
            </h4>
            <div class="row g-3">
